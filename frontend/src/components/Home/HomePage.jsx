    ...
    <>
      <div className="bg-gradient-to-r from-red-500 to-yellow-300 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-green-600 font-semibold rounded-xl shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
      ...
      <div className="bg-gray-100 py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-xl">
            ...
            {/* <FaQuoteRight className="text-xl text-right mt-4 text-gray-500" /> */}
          </div>
